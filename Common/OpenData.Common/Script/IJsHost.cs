...
namespace OpenData.Script
{
    ...
    public class JavascriptExecuter
    {
        ...
        private static IJsHost GetJsHost(string jsCode)
        {
            ...
            parameter.ReferencedAssemblies.Add(@"D:\Work\Bzway\Bzway.Framework\bin\Debug\Bzway.Framework.dll");
            ...
            var sourceCode = File.ReadAllText(@"D:\Work\Bzway\Bzway.Framework\bin\Debug\Script\Template.cs");
            ...
            //获取当前实例的 Type
            var instance = (IJsHost)assembly.CreateInstance("Bzway.Framework.Script.JsHost");
            if (instance != null)
            {
