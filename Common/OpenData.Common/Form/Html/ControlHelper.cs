...
// 
#endregion
using OpenData.Website.Common;
using OpenData.Website.Form.Html.Controls;
using System;
...
namespace OpenData.Website.Form.Html
{
    public static class ControlHelper
    {
        ...
        static ControlHelper()
        {
            ...
            TemplateVirtualPath = OpenData.Web.Url.UrlUtility.Combine(baseDir.AppDataVirutalPath, "ContentType_Templates", "Controls");
            ...
            RegisterControl(new OpenData.Website.Form.Html.Controls.File());
        ...
        public static IEnumerable<string> ResolveAll()
        {
            ...
            if (OpenData.Web.TrustLevelUtility.CurrentTrustLevel == AspNetHostingPermissionLevel.Unrestricted)
            {
        ...
        {
            return OpenData.Web.Url.UrlUtility.Combine(TemplateVirtualPath, controlType + ".cshtml");
        }
