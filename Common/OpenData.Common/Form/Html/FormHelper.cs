...
namespace OpenData.Website.Form.Html
{
    public static class FormHelper
    {
        ...
        static FormHelper()
        {
            ...
            TemplateVirtualPath = OpenData.Web.Url.UrlUtility.Combine(baseDir.AppDataVirutalPath, "ContentType_Templates", "Forms");
        ...
        {
            return OpenData.Web.Url.UrlUtility.Combine(TemplateVirtualPath, form + ".cshtml");
        }
