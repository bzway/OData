...
using OpenData.Site;
using OpenData.Site.Form.Html.Controls;
using System;
...
namespace OpenData.Site.Form.Html
{
    public static class ControlHelper
    {
        ...
        static ControlHelper()
        {
            ...
            RegisterControl(new OpenData.Site.Form.Html.Controls.File());
        ...
        public static IEnumerable<string> ResolveAll()
        {
            ...
            if (OpenData.Site.TrustLevelUtility.CurrentTrustLevel == AspNetHostingPermissionLevel.Unrestricted)
            {
