...
namespace OpenData.Framework.Form.Html
{
    public static class ValidationExtensions
    {
        ...
        {
            if (column.DataType == ColumnType.Int || column.DataType == ColumnType.Decimal)
            {
            ...
            if (column.DataType == ColumnType.String && column.Length > 0)
            {
        ...
        public static IDictionary<string, string> GetUnobtrusiveValidationAttributes(IColumn column)
        {
        ...
        public static string GetUnobtrusiveValidationAttributeString(IColumn column)
        {
            ...
            foreach (KeyValuePair<string, string> pair in attributes)
            {
                ...
                {
                    string str2 = pair.Value.RazorHtmlAttributeEncode();
