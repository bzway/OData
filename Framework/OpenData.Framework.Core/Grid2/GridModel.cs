...
using OpenData.Site.Grid2.Design;
...
namespace OpenData.Site.Grid2
{
    public class GridModel : IGridModel
    {
        ...
        public static IGridModel CreateGridModel(Type modelType, IEnumerable dataSource, ViewContext viewContext)
        {
            ...
            {
                throw new InvalidOperationException("Please setup BzwayDataAnnotationsModelMetadataProvider, etc:ModelMetadataProviders.Current = new Bzway.Web.Web.BzwayDataAnnotationsModelMetadataProvider()");
            }
        ...
        protected virtual void Initialize()
        {
            ...
            this.Draggable = GridAttribute.Draggable;
